...
class EmployeeRepositoryTest {
    ...
    @Test
    @DisplayName("Save employee - should create employee")
    ...
    @Test
    @DisplayName("Find by ID - should return saved employee")
    void testFindById() {
        Employee savedEmployee = employeeRepository.save(employee);
    ...
    @Test
    @DisplayName("Find all - should return list of employees")
    void testFindAll() {
    ...
    @Test
    @DisplayName("Update employee - should update employee fields")
    ...
    @Test
    @DisplayName("Delete employee - should remove employee from repository")
